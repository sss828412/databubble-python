...
# again (see scripts/check_journey_drift.py — this is the class of bug that
...
echo "1) Journey route drift check ..."
python3 scripts/check_journey_drift.py

echo
echo "2) Running test suite ..."
python3 -m pytest tests/test_sdk.py tests/test_sdk_journeys.py -q
